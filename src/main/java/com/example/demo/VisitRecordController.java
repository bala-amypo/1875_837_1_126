...
public class VisitRecordController {
    ...
    @GetMapping("/{id}") public VisitRecord getById(@PathVariable Long id) { return service.getVisitById(id).orElseThrow(()->new NoSuchElementException("Visit record not found")); }
