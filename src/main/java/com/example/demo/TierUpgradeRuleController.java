...
public class TierUpgradeRuleController {
    ...
    @GetMapping("/lookup") public TierUpgradeRule getRule(@RequestParam String fromTier, @RequestParam String toTier) { return service.getRule(fromTier, toTier).orElseThrow(()->new NoSuchElementException("Rule not found")); }
}