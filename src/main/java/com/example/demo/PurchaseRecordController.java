...
public class PurchaseRecordController {
    ...
    @GetMapping("/{id}") public PurchaseRecord getById(@PathVariable Long id) { return service.getPurchaseById(id).orElseThrow(()->new NoSuchElementException("Purchase record not found")); }
